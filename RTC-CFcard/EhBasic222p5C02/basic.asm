...
;  have been removed as they aren't needed with the CO2 Pocket SBC:
; - IRQ
; - RETIRQ
; - NMI
; - RETNMI
...
;
; NOTE: Input Buffer and Vectors moved to Page $05 for BIOS Version 3.03 - 5th February 2021
;
...
; Updated C02BIOS and C02Monitor to version 3.01
; Note: C02BIOS uses Page Zero locations from $D8 - $FF
; C02Monitor uses Page Zero locations from $A0 - $D7

; add page zero variables for Xmodem transfer using the CO2 Monitor routines

PGZERO_ST       .EQU $A0               ; Start of Page Zero usage (C02 Monitor)
