...
;*                                                                                                *
;*                                                                                                *
;*                                  14/05/2021 (Day/Month/Year)                                   *
;*                                                                                                *
;**************************************************************************************************
; C02BIOS / C02Monitor Version is now 3.04                                                        *
...
;
IDE_LBA0        .EQU    PGZERO_ST+49            ;IDE LBA Variables for DOS/65
IDE_LBA1        .EQU    PGZERO_ST+50
IDE_LBA2        .EQU    PGZERO_ST+51
;
...
MATCH           .EQU    BIOS_PG0+39             ;Bit7 used for Delay, Bit6 used for Benchmark
                                                ;Bits 5,4 used for BRG Test register status
...
;**************************************************************************************************
;EnHanced Basic or DOS/65 can be called from the Monitor via the Ctrl-B comand.
; The default is different for each of these optional software components.
;
;The start location is just added here for convienience, but should be changed as needed.
;
